...
use App\Http\Middleware\Authenticate;
  ...
  Route::group(['prefix' => 'admin', 'namespace' => 'Admin', 'middleware' => ['auth','admin']], function () {
    ...
    Route::get('/vacations/{id}/edit', [VacationController::class, 'edit'])->name('admin.vacations.edit');
    Route::post('/vacations/{id}/update', [VacationController::class, 'editVacation'])->name('admin.vacations.update');
    ...
    Route::post('/editInsurance', [StaffController::class, 'editInsurance'])->name('admin.editInsurance');
    Route::post('staff/editDependent/{id}', [StaffController::class, 'editDependent'])->name('admin.editDependent');
    ...
    Route::delete('/salaries/deductables/delete/{deductable}', [PayDeductController::class, 'destroydeductable'])->name('admin.deductables.delete');
    Route::delete('/salaries/payables/delete/{payable}', [PayDeductController::class, 'destroypayable'])->name('admin.payable.delete');
    Route::post('/salaries/deductables', [PayDeductController::class, 'storedeductables'])->name('admin.salaries.deductables.store');
    Route::post('/salaries/deductables/edit/{deductable}', [PayDeductController::class, 'editdeductables'])->name('admin.salaries.deductables.edit');
    Route::post('/salaries/payables/edit/{payable}', [PayDeductController::class, 'editpayables'])->name('admin.salaries.payables.edit');
