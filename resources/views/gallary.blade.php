...
@section('content')
    ...
    <div class="container py-4">
        ...
        <div class="row g-3">
            ...
            <div class="col-6 col-md-3 col-lg-2">
                <img src="{{ asset(str_replace('public/', 'storage/', $file . '?v=20260107')) }}"
                    class="img-thumbnail gallery-thumb" alt="Gallery Image {{ $index }}" data-bs-toggle="modal"
                    data-bs-target="#imageModal" data-index="{{ $index }}">
                <div class="text-center" style="color: #5c5c5c; margin-top: 15px">{{ app()->getLocale() === 'ar' ? "منشور
                    $index" : "Post $index" }}</div>
            </div>
            @endforeach
        </div>
    </div> --}}
    ...
    <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-3">
        @foreach ($images as $index => $file)
            <div class="col">
                <img src="{{ $file->path }}" class="img-fluid gosi" alt="Gallery Image {{ $index }}">
            </div>
        @endforeach
    </div>
@endsection
