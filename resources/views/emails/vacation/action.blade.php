          ...
          <tbody>
            <tr width="100%" height="60">
              <td valign="top" align="left" style="border-top-left-radius:4px;border-top-right-radius:4px;background:#27709b url(https://ci5.googleusercontent.com/proxy/EX6LlCnBPhQ65bTTC5U1NL6rTNHBCnZ9p-zGZG5JBvcmB5SubDn_4qMuoJ-shd76zpYkmhtdzDgcSArG=s0-d-e1-ft#https://trello.com/images/gradient.png) bottom left repeat-x;padding:10px 18px;text-align:center">
                <img height="40" width="40" src="https://inaya.edu.sa/images/imcFav.ico" title="Inaya" style="font-weight:bold;font-size:18px;color:#fff;vertical-align:top" class="CToWUd">
              </td>
            </tr>
            <tr width="100%">
              <td valign="top" align="left" style="background:#fff;padding:18px">
                <h1 style="font-size:20px;margin:16px 0;color:#333;text-align:center"> Vacation Action </h1>
                <p style="font:15px/1.25em 'Helvetica Neue',Arial,Helvetica;color:#333;">From: {{ $vacation->start_date }} </p>
                <p style="font:15px/1.25em 'Helvetica Neue',Arial,Helvetica;color:#333;">To: {{ $vacation->end_date }} </p>
                <p style="font:15px/1.25em 'Helvetica Neue',Arial,Helvetica;color:#333;">Type: {{ $vacation->to }} </p>
                <p style="font:15px/1.25em 'Helvetica Neue',Arial,Helvetica;color:#333;">Action: {{ $vacation->detail->headStatus->workflow_status_en }} </p>
                <p style="font:15px/1.25em 'Helvetica Neue',Arial,Helvetica;color:#333;">Notes: <br>{{ $vacation->detail?->head_notes }} </p>
                <div style="background:#f6f7f8;border-radius:3px"> <br>
                  ...
                  <p style="font:15px/1.25em 'Helvetica Neue',Arial,Helvetica;margin-bottom:0;text-align:center">
                    <a href="{{ route('vacations.show', $vacation->id) }}" style="border-radius:3px;background:#3aa54c;color:#fff;display:block;font-weight:700;font-size:16px;line-height:1.25em;margin:24px auto 6px;padding:10px 18px;text-decoration:none;width:180px" target="_blank"> See Details</a>
                  </p>
                  <br><br>
                </div>
