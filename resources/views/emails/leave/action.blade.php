          ...
          <tbody>
            ...
            <tr width="100%">
              <td valign="top" align="left" style="background:#fff;padding:18px">
                <h1 style="font-size:20px;margin:16px 0;color:#333;text-align:center"> Permission Action </h1>
                ...
                <p style="font:15px/1.25em 'Helvetica Neue',Arial,Helvetica;color:#333;">Action: {{ $leave->detail->headStatus->workflow_status_en }} </p>
                <p style="font:15px/1.25em 'Helvetica Neue',Arial,Helvetica;color:#333;">Notes: <br>{{ $leave->detail?->head_notes }} </p>
                <div style="background:#f6f7f8;border-radius:3px"> <br>
                  ...
                  <p style="font:15px/1.25em 'Helvetica Neue',Arial,Helvetica;margin-bottom:0;text-align:center">
                    <a href="{{ route('leaves.show', $leave->id) }}" style="border-radius:3px;background:#3aa54c;color:#fff;display:block;font-weight:700;font-size:16px;line-height:1.25em;margin:24px auto 6px;padding:10px 18px;text-decoration:none;width:180px" target="_blank"> See Details</a>
                  </p>
                  <br><br>
                </div>
