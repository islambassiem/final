          ...
          <tbody>
            ...
            <tr width="100%">
              <td valign="top" align="left" style="background:#fff;padding:18px">
                <h1 style="font-size:20px;margin:16px 0;color:#333;text-align:center"> Document Expiry Reminder</h1>
                <p style="font:15px/1.25em 'Helvetica Neue',Arial,Helvetica;color:#333;">Kindly be informed that your {{ $description }} will be expired on</p>
                <div style="background:#f6f7f8;border-radius:3px"> <br>
                  <p style="text-align:center"> <a style="color:#306f9c;font:26px/1.25em 'Helvetica Neue',Arial,Helvetica;text-decoration:none;font-weight:bold">{{ $expiry }}</a> </p>
                  <br><br>
                </div>
