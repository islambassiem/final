          ...
          <tbody>
            ...
            <tr width="100%">
              <td valign="top" align="left" style="background:#fff;padding:18px" colspan="2">
                <h1 style="font-size:20px;margin:16px 0;color:#333;text-align:center"> Family Visit Request - طلب زياره عائلية</h1>
              </td>
            </tr>
            <tr width="100%">
              ...
              <td valign="top" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">{{ $visit->user->getFullEnglishNameAttribute }}</p>
                <p style="color:#333;">{{ $visit->user->getFullArabicNameAttribute }}</p>
              </td>
            </tr>
            <tr width="100%">
              <td valign="top" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">Request No</p>
                <p style="color:#333;">رقم الطلب</p>
              </td>
              <td valign="middle" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">{{ $visit->number }}</p>
              </td>
            </tr>
            <tr width="100%">
              <td valign="top" align="left" style="background:#fff;padding:18px">
              ...
              <td valign="middle" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">{{ ($visit->user->iqama($visit->user_id))->document_id }}</p>
              </td>
            </tr>
          </tbody>
        </table>
