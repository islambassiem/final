          ...
          <tbody>
            ...
            <tr width="100%">
              <td valign="top" align="left" style="background:#fff;padding:18px" colspan="2">
                <h1 style="font-size:20px;margin:16px 0;color:#333;text-align:center"> Exit Re-entry  Request - طلب خروج وعوده</h1>
              </td>
            </tr>
            <tr width="100%">
              ...
              <td valign="top" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">{{ $visa->user->getFullEnglishNameAttribute }}</p>
                <p style="color:#333;">{{ $visa->user->getFullArabicNameAttribute }}</p>
              </td>
            </tr>
            <tr width="100%">
              <td valign="top" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">Departure Date</p>
                <p style="color:#333;">تاريخ المغادرة</p>
              </td>
              <td valign="middle" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">{{ $visa->from }}</p>
              </td>
            </tr>
            <tr width="100%">
              <td valign="top" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">Arrival Date</p>
                <p style="color:#333;">تاريخ الوصول</p>
              </td>
              <td valign="middle" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">{{ $visa->to }}</p>
              </td>
            </tr>
            <tr width="100%">
              <td valign="top" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">No of Days</p>
                <p style="color:#333;">عدد الايام</p>
              </td>
              <td valign="middle" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">{{ $visa->days() }}</p>
              </td>
            </tr>
            <tr width="100%">
              <td valign="top" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">Iqama No</p>
                <p style="color:#333;">رقم الاقامة</p>
              </td>
              <td valign="middle" align="left" style="background:#fff;padding:18px">
                <p style="color:#333;">{{ ($visa->user->iqama($visa->user_id))->document_id }}</p>
              </td>
            </tr>
          </tbody>
        </table>
