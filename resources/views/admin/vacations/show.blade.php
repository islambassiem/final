            ...
            <div class="col-md-6">
                <div class="d-flex justify-content-end gap-1">
                    ...
                    @if ($vacation->hasAttachment())
                        <a href="{{ route('attachment.vacation', $vacation->id) }}" target="_blank"
                            class="btn btn-info btn-sm py-0 d-flex justify-content-center align-items-center" data-bs-toggle="tooltip" data-bs-placement="top"
                            data-bs-title="{{ __('global.link') }}">
                            <i class="bi bi-paperclip"></i>
                        </a>
                    @endif
                    <a href="{{ route('admin.vacations.edit', $vacation->id) }}"
                        class="btn btn-secondary">{{ __('global.edit') }}</a>
        ...
        <div class="row">
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="border pt-2 ps-3 mx-3 mb-3" style="min-height:50px">
                        {{ $vacation->detail?->employee_notes }}</div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-title ps-3 pt-3 pb-0">{{ __('head/vacations.notes') }}</div>
                    <div class="border pt-2 ps-3 mx-3 mb-3" style="min-height:50px">{{ $vacation->detail?->head_notes }}
                    </div>
                </div>
            </div>
            <div class="col-md-4">
                <div class="card">
                    ...
                    <div class="card-title ps-3 pt-3 pb-0">{{ __('head/vacations.notes') }}</div>
                    <div class="border pt-2 ps-3 mx-3 mb-3" style="min-height:50px">{{ $vacation->detail?->hr_notes }}
                    </div>
                </div>
            </div>
        </div>
