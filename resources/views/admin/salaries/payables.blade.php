...
<div class="row">
  ...
  {{--  Edit Payables  --}}
  <div class="modal fade" id="editPayable" tabindex="-1" aria-labelledby="editPayableModal" aria-hidden="true">
    <div class="modal-dialog">
      <div class="modal-content">
        <div class="modal-header">
          <h1 class="modal-title fs-5" id="editPayableLabel">{{ __('admin/salaries.editPayable') }}</h1>
          <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
        </div>
        <div class="modal-body">
...
@section('script')
  ...
  <script>
    $(document).ready(function (){
      ...
      $('#editPayable').on('show.bs.modal', function (event){
