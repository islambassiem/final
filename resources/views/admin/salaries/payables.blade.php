...
<div class="row">
  ...
  <div class="row">
    <div class="col d-flex justify-content-between">
      <a href="{{ route('admin.salaries.non.working', $month_id) }}" class="btn btn-danger">{{ __('global.back') }}</a>
      <a href="{{ route('admin.salaries.deductables', $month_id) }}" class="btn btn-primary">{{ __('global.next') }}</a>
    </div>
  </div>
