...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      <a class="nav-link {{ request()->segment(1) == 'bylaws' ? '' : 'collapsed' }}" href="{{ route('bylaws.index') }}">
        <i class="bi bi-paperclip"></i>
    ...
    @if (auth()->user()->id == 466)
      <li class="nav-item">
        <a class="nav-link {{ request()->segment(1) == 'open-data' ? '' : 'collapsed' }}" href="{{ route('open-data') }}">
          <i class="bi bi-paperclip"></i>
