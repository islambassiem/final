  ...
  <nav class="header-nav ms-auto">
    <ul class="d-flex align-items-center">
      ...
      {{-- <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow notifications">
          ...
          <li class="dropdown-header">
            ...
            <a href="{{ route('read.all.notifications') }}"><span class="badge rounded-pill bg-primary p-2 ms-2">{{
                __('header.markall') }}</span></a>
          </li>
          <li>
      ...
      {{-- <li class="nav-item dropdown">
        ...
        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow messages">
          ...
          <li class="dropdown-header">
            <h4>تعزية</h4>
            <a href="https://csmonline.net/storage/announcements/Condolence.pdf" target="_blank"><span
                class="badge rounded-pill bg-primary p-2 ms-2">عرض</span></a>
          </li>
      </li>
      <li>
        <hr class="dropdown-divider">
      ...
      <li class="dropdown-header">
        <h4>Memo</h4>
        <a href="https://csmonline.net/storage/announcements/Memo.pdf" target="_blank"><span
            class="badge rounded-pill bg-primary p-2 ms-2">عرض</span></a>
      </li>
      </li>
      <li>
    ...
    <li class="nav-item dropdown pe-3">
      ...
      <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
        <li class="dropdown-header">
          <h6>
            {{ auth()->user()->{'first_name' . session('_lang')} . ' ' . auth()->user()->{'family_name' . session('_lang')} }}
          </h6>
