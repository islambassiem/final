...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse show" data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="charts-echarts" class="active">
  ...
  <main id="main" class="main">
    ...
    <p>ECharts Examples. You can check the <a href="https://echarts.apache.org/examples/en/index" target="_blank">official website</a> for more examples.</p>
